      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-[#3d5156] rounded-2xl shadow-2xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-[#4a6669] rounded-xl p-6 pr-10">
              <div className="text-white mb-4 flex justify-between items-center text-sm">
                <p>Calculate what you could be paying in fees to sell your home with an agent:</p>
                <p className="text-[#5DD5D9] font-semibold whitespace-nowrap ml-2">
                  Only pay $795 when you sell with SBY
                </p>
              </div>

              {/* Single Horizontal Line Calculator */}
              <div className="flex items-center justify-center gap-3 text-base pl-6">
                {/* Home Sale Price */}
