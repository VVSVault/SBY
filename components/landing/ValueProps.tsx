export default function ValueProps() {
  return (
    <section className="pt-20 pb-0 md:pb-0 pb-16 px-4 bg-[#738286]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto mb-8 rounded-2xl overflow-hidden shadow-2xl">
            <video
              src="https://pub-723cf289193a4aaf99eb07deb8d15315.r2.dev/sold_by_you%20(1440p).mp4"
              controls
              preload="auto"
        ...
        <div className="hidden lg:block relative max-w-6xl mx-auto h-[650px] -mt-8">
          {/* Center Circle */}
          ...
          <div className="w-full">
            {/* Benefit 1 - Top Left */}
            <div className="absolute top-12 left-0 w-96 h-64 bg-white/80 hover:bg-white rounded-2xl p-8 shadow-lg flex flex-col transition-all duration-300">
            ...
            {/* Benefit 2 - Top Right */}
            <div className="absolute top-12 right-0 w-96 h-64 bg-white/80 hover:bg-white rounded-2xl p-8 shadow-lg flex flex-col transition-all duration-300">
              <div className="w-16 h-16 bg-[#FFD700] rounded-full flex items-center justify-center mb-3 mx-auto">
            ...
            <div className="absolute bottom-12 left-0 w-96 h-64 bg-white/80 hover:bg-white rounded-2xl p-8 shadow-lg flex flex-col transition-all duration-300">
              <div className="w-16 h-16 bg-[#FFD700] rounded-full flex items-center justify-center mb-3 mx-auto">
                <span className="text-3xl">🏠</span>
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2 text-center">
            ...
            <div className="absolute bottom-12 right-0 w-96 h-64 bg-white/80 hover:bg-white rounded-2xl p-8 shadow-lg flex flex-col transition-all duration-300">
              <div className="w-16 h-16 bg-[#FFD700] rounded-full flex items-center justify-center mb-3 mx-auto">
                <span className="text-3xl">📋</span>
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2 text-center">
        ...
        <div className="lg:hidden max-w-2xl mx-auto px-4 space-y-6">
          {/* Center Pricing Circle */}
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="w-48 h-48 rounded-full bg-gray-600 flex items-center justify-center">
                <div className="w-36 h-36 rounded-full bg-gray-700 flex flex-col items-center justify-center">
                  <p className="text-white text-xs mb-1">SBY Cost</p>
                  <p className="text-[#FFD700] text-3xl font-bold">$795</p>
                </div>
              </div>
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-center">
                <p className="text-cyan-400 text-xs">Seller Agent Fee</p>
                <p className="text-white text-lg font-bold relative inline-block">
                  $16,800
                  <span className="absolute left-0 right-0 top-1/2 h-0.5 bg-cyan-400 transform -rotate-12"></span>
                </p>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <div className="w-14 h-14 bg-[#FFD700] rounded-full flex items-center justify-center mb-3 mx-auto">
